...
# 4. Getting Started:
Here are a few basic guidelines, that might be helpful, while contributing to this project
...
* Add a upstream link to main branch in your cloned repo
    ```
    git remote add upstream https://github.com/Vyvy-vi/portfolio
    ```
...
By contributing, you agree that your contributions will be licensed under [LICENSE](./LICENSE.md)
